            ...
            <div class="header-container container">
                ...
                <div class="nav-actions">
                    ...
                    <div class="nav-icons">
                        ...
                        <a href="{{route('comparare')}}" class="mobile-dissapear"><i class="fa-solid fa-scale-unbalanced-flip @if (isset($page) && $page != 'home') black @endif"></i></a>
                        ...
                        <div class="nav-menu">
                            ...
                            <div class="menu">
                                ...
                                <div class="mobile">
                                    ...
                                    <a href="{{route('comparare')}}"><i class="fa-solid fa-scale-unbalanced-flip"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
